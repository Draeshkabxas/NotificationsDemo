...
// Step 3: Add the earth image to drawable and Create an object and define the static data for Big Picture Style that we will use while building notification.
// START
